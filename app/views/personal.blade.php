...
<div class="container-fluid personal-container">
    <div class="page-header personal-header col-lg-12 col-xl-12">
    ...
    <!--BOX 1-->
    <div class="personal-box col-xl-4 col-lg-4 col-md-4 col-xs-12 personal-coding">
    ...
    <!--BOX 2-->
    <div class="personal-box col-xl-4 col-lg-4 col-md-4 col-xs-12 personal-meetup">
    ...
    <!--BOX 3-->
    <div class="personal-box col-xl-4 col-lg-4 col-md-4 col-xs-12 personal-self">
